...
export function buildBirthdaySign(age) {
	const ageWord = age >= 50 ? 'mature' : 'young'
	return `Happy Birthday! What a ${ageWord} fellow you are.`
}
...
export function costOf(sign, currency) {
	const BASE_PRICE = 20
	const extraMoney = BASE_PRICE + (sign.length * 2)
	return `Your sign costs ${extraMoney}.00 ${currency}.`
}
